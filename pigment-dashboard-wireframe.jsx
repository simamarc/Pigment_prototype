...
const agentsData = [
  ...
  },
  {
    ...
    status: "active",
    description: "Monitors market rates, competitor pricing, and demand patterns. Automatically adjusts nightly rates to maximize revenue and occupancy across the portfolio.",
    ...
    propertiesManaged: 35,
    tasks: [
      { name: "Monitor competitor rates", mode: "auto", description: "Continuously tracks pricing of comparable listings within proximity of each property.", escalations: ["Competitor drops rates > 15% → Alert operator with recommendation"], thresholds: {} },
      { name: "Generate pricing reports", mode: "auto", description: "Creates weekly competitive analysis with rate comparisons and occupancy forecasts.", escalations: [], thresholds: {} },
      { name: "Suggest rate changes", mode: "auto", description: "Proposes nightly rate adjustments based on demand, competition, and seasonality.", escalations: ["Occupancy below 60% for 2 weeks → Suggest price reduction", "Demand spike detected → Suggest rate increase + notify"], thresholds: { maxPriceChange: "15%", minimumMargin: "20%", peakSeasonMultiplier: "1.3x" } },
      { name: "Apply rate adjustments", mode: "approval", description: "Pushes approved rate changes to all connected booking platforms.", escalations: ["Owner rate conflicts with optimization → Escalate to operator"], thresholds: { maxPriceChange: "15%" } },
      { name: "Set minimum nightly floor", mode: "approval", description: "Defines the lowest acceptable rate per property. Requires operator sign-off.", escalations: [], thresholds: { minimumMargin: "20%" } },
      { name: "Override owner-set prices", mode: "disabled", description: "Owner-defined pricing can only be changed with explicit owner agreement.", escalations: [], thresholds: {} },
    ],
    recentActions: [
      { time: "08:00", action: "Detected 20% rate drop by competitors near Apt. Gambetta", status: "escalated" },
      { time: "Yesterday", action: "Adjusted rates for 12 properties (peak season)", status: "auto" },
      { time: "2 days ago", action: "Generated weekly competitive analysis", status: "auto" },
    ],
    chatSuggestions: [
      "How are our rates vs competitors?",
      "Which properties need price adjustments?",
      "Show occupancy forecast for August",
      "What's the optimal rate for Villa Mimosa?",
    ],
    sampleResponses: {
      "How are our rates vs competitors?": "Competitive pricing overview:\n\n✅ Well-positioned (within 5%): 7 properties\n⚠️ Above market (5-15% higher): 4 properties\n🔴 Significantly above (>15%): 1 property (Apt. Gambetta)\n💪 Below market (opportunity to raise): 3 properties\n\nKey finding: 3 comparable listings near Apt. Gambetta dropped prices 15-20% for next week. I recommend reducing from €97/night to €85/night.\n\nOverall, your portfolio average (€108/night) is 3% above market — healthy but Apt. Gambetta needs attention.",
    },
    integrations: [
      { name: "AirDNA (market data)", status: "connected" },
      { name: "Airbnb Pricing API", status: "connected" },
      { name: "Booking.com Rates", status: "connected" },
      { name: "PriceLabs", status: "disconnected" },
    ],
    managedProperties: [
      { name: "Apt. Gambetta", status: "action" },
      { name: "Villa Mimosa", status: "ok" },
      { name: "Maison Cimiez", status: "ok" },
      { name: "Apt. Port", status: "ok" },
      { name: "Apt. Libération", status: "ok" },
    ],
  },
  {
